            ...
            <div class="col-md-8">
             <div class="card mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- 03. Searching -->
                        <form id="todo-form" action="{{ url('/todo') }}" method="get">
                            <div class="input-group mb-3">
                        ...
                        <ul class="list-group mb-4" id="todo-list">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <input type="text" class="form-control edit-input" style="display: none;"
                                    value="{{ $item->task }}">
                                    <div class="btn-group">
                                        <form action="{{ route('todo.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this task?');">
                                            @csrf
                                            @method('DELETE')
